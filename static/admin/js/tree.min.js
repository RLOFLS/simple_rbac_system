            ...
            function(b) {
                ...
                function(b, c) {
                    ...
                    if ("folder" === c.type) {
                        ...
                        0)
                    } else "item" === c.type ? (e = d.$element.find("[data-template=treeitem]:eq(0)").clone().removeClass("hide hidden").removeData("template").removeAttr("data-template"),
                     e.find(".tree-item-name > .tree-label").html(c.text || c.name), 
                     e.data(c),
                     "additionalParameters" in c && "item-selected" in c.additionalParameters && 1 == c.additionalParameters["item-selected"] && (e.addClass("tree-selected"),
                     e.find("i").removeClass(d.options["unselected-icon"]).addClass(d.options["selected-icon"]))) : "overflow" === c.type && (e = d.$element.find("[data-template=treeoverflow]:eq(0)").clone().removeClass("hide hidden").removeData("template").removeAttr("data-template"),
                     e.find(".tree-overflow-name > .tree-label").html(c.text || c.name), e.data(c));

                     e.attr("data-code",c.code);
